document.addEventListener('DOMContentLoaded', () => {
    ...
    function activarPantallaCompleta() {
        ...
        if (elemento.requestFullscreen) {
            elemento.requestFullscreen().catch(err => console.log("No se pudo iniciar pantalla completa."));
    ...
    // 7. Botón "ESTOY LISTO" -> Pide permisos e inicia
    document.getElementById('btn-empezar-turno').addEventListener('click', () => {
        
        // Forzamos el modo Fullscreen para que desaparezca la barra del navegador
    ...
    function finalizarTurno() {
        ...
        // Salir de pantalla completa si lo desean, aunque es mejor dejarla
