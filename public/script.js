document.addEventListener('DOMContentLoaded', () => {
    ...
    // Controles táctiles
    const btnPasar = document.getElementById('zona-pasar');
    const btnCorrecto = document.getElementById('zona-correcto');
    ...
    document.getElementById('btn-iniciar-ronda').addEventListener('click', () => {
        ...
        guardarEstado();
        prepararPantallaTurno(); // Sin pedir permisos raros
    });
    ...
    // ==========================================
    // EVENTOS TÁCTILES (REEMPLAZAN AL GIROSCOPIO)
    // ==========================================
    
    // Función centralizada para procesar la acción
    function procesarAccion(tipo) {
        ...
        }, 600); // Lo hice un poquito más rápido para que sea más dinámico al tacto
    }

    // Escuchadores de Click/Touch
    btnCorrecto.addEventListener('click', () => procesarAccion('correcto'));
    btnPasar.addEventListener('click', () => procesarAccion('pasar'));
